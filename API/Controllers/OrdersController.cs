...
namespace API.Controllers
{
    ...
    public class OrdersController(ICartService cartService, IUnitOfWork unitOfWork) : BaseApiController
    {
        ...
        public async Task<ActionResult<Order>> CreateOrder(CreateOrderDto createOrderDto)
        {
            ...
            if(cart == null) return BadRequest("Unable to locate cart");
            ...
            foreach(var item in cart.Items)
            {
                ...
                if(productItem == null) return BadRequest("Unable to locate product item");
            ...
            if(deliveryMethod == null) return BadRequest("No delivery method has been selected");
